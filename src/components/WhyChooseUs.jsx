  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1920&q=50)' }}
      />
      <div className="absolute inset-0" style={{ background: 'rgba(17,17,17,0.9)' }} />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
          {REASONS.map((reason, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className="relative w-16 h-16 rounded-xl flex items-center justify-center text-primary mb-5 transition-transform duration-500 group-hover:scale-110"
                style={{
              ...
              {/* Title */}
              <h3 className="relative font-heading font-bold text-lg text-primary mb-1">
                {reason.title}
              </h3>
              <h4 className="relative font-heading font-semibold text-sm text-white mb-3 group-hover:text-primary transition-colors duration-300">
                {reason.subtitle}
              </h4>

              {/* Description */}
              <p className="relative font-body text-xs md:text-sm text-text-secondary leading-relaxed">
                {reason.desc}
              </p>
            </div>
          ))}
